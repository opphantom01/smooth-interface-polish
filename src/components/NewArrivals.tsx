          ...
          >
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-xs text-muted-foreground mb-2">Sizes: {product.sizes.join(", ")}</p>
              </div>
              <div className="text-sm font-bold">{product.priceLabel}</div>
            </div>
          </motion.button>
        ))}
      </div>
